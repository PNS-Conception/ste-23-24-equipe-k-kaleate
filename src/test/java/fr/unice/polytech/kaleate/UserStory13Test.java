...
public class UserStory13Test {
    ...
    public static void createCommandes(){
        ...
        Commandable menu2 = restaurant1.getMenus(Commandable.class).get(1);
        ...
        Commandable menu3 = restaurant1.getMenus(Commandable.class).get(2);
        ...
        Commandable menu5 = restaurant2.getMenus(Commandable.class).get(1);
        ...
        Commandable menu6 = restaurant2.getMenus(Commandable.class).get(2);
